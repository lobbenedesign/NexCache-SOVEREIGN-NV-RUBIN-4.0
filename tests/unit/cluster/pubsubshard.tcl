...
test "Pub/Sub shard basics" {
    ...
    set publishclient [nexcache_client_by_addr $publishnode(host) $publishnode(port)]
    set subscribeclient [nexcache_deferring_client_by_addr $publishnode(host) $publishnode(port)]
    set subscribeclient2 [nexcache_deferring_client_by_addr $publishnode(host) $publishnode(port)]
    set anotherclient [nexcache_deferring_client_by_addr $notshardnode(host) $notshardnode(port)]
...
test "Verify Pub/Sub and Pub/Sub shard no overlap" {
    ...
    set publishshardclient [nexcache_client_by_addr $publishnode(host) $publishnode(port)]
    set publishclient [nexcache_deferring_client_by_addr $publishnode(host) $publishnode(port)]
    set subscribeshardclient [nexcache_deferring_client_by_addr $publishnode(host) $publishnode(port)]
    set subscribeclient [nexcache_deferring_client_by_addr $publishnode(host) $publishnode(port)]
...
test "PUBSUB channels/shardchannels" {
    set subscribeclient [nexcache_deferring_client_by_addr $publishnode(host) $publishnode(port)]
    set subscribeclient2 [nexcache_deferring_client_by_addr $publishnode(host) $publishnode(port)]
    set subscribeclient3 [nexcache_deferring_client_by_addr $publishnode(host) $publishnode(port)]
    set publishclient [nexcache_client_by_addr  $publishnode(host) $publishnode(port)]
