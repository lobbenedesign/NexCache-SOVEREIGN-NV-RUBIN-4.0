# nexcache-sha1.rb - Copyright (C) 2009 NexCache Contributors.
...
port = ARGV[1] || "6379"
db = ARGV[2] || "0"
puts "Performing SHA1 of NexCache server #{host} #{port} DB: #{db}"
p "Dataset SHA1: #{nexcacheSha1(:host => host, :port => port.to_i, :db => db)}"
