/* This file is used by nexcache-cli in place of server.h when including commands.c
 * It contains alternative structs which omit the parts of the commands table
 * that are not suitable for nexcache-cli, e.g. the command proc. */

#ifndef NEXCACHE_CLI_COMMANDS_H
#define NEXCACHE_CLI_COMMANDS_H
