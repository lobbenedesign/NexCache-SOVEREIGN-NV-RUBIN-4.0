 ...
 * ============================================================
 * Redis Streams è potente ma NON gestisce la velocità del consumer.
 *
 * Il problema:
 *   Producer → 1M msg/sec
 *   Consumer → 100K msg/sec
 *   Redis: riempie buffer → OOM → crash o eviction massiva
 *
 ...
 * @stream_name: Nome dello stream Redis esistente
