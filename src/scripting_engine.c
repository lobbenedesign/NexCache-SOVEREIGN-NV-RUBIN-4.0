...
typedef struct scriptingEngine {
    ...
    NexCacheModule *module;                                     /* the module that implements the scripting engine */
    scriptingEngineImpl impl;                                 /* engine context and callbacks to interact with the engine */
    NexCacheModuleCtx *module_ctx_cache[MODULE_CTX_CACHE_SIZE]; /* Cache of module context objects */
} scriptingEngine;
 ...
 * that are loaded in the server and implemented by NexCache Modules.
 *
...
static NexCacheModuleCtx *engineSetupModuleCtx(int module_ctx_cache_index,
                                             scriptingEngine *e,
    ...
    NexCacheModuleCtx *ctx = e->module_ctx_cache[module_ctx_cache_index];
...
compiledFunction **scriptingEngineCallCompileCode(scriptingEngine *engine,
    ...
    NexCacheModuleCtx *module_ctx = engineSetupModuleCtx(COMMON_MODULE_CTX_INDEX, engine, false, NULL);
...
void scriptingEngineCallFreeFunction(scriptingEngine *engine,
    ...
    NexCacheModuleCtx *module_ctx = engineSetupModuleCtx(FREE_FUNCTION_MODULE_CTX_INDEX, engine, false, NULL);
...
void scriptingEngineCallFunction(scriptingEngine *engine,
    ...
    NexCacheModuleCtx *module_ctx = engineSetupModuleCtx(COMMON_MODULE_CTX_INDEX, engine, true, caller);
...
engineMemoryInfo scriptingEngineCallGetMemoryInfo(scriptingEngine *engine,
                                                  subsystemType type) {
    NexCacheModuleCtx *module_ctx = engineSetupModuleCtx(GET_MEMORY_MODULE_CTX_INDEX, engine, false, NULL);
