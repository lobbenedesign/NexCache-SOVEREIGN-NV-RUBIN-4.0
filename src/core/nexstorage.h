...
nexstorage_del(NexStorage *ns, const char *key, uint32_t key_len) {
     ...
     * Misurato su VERAM3.3 con `sample` sotto carico SET puro:
     * nexdash_del appariva come hotspot reale nonostante SET scriva SOLO
     * stringhe. Stesso fix portato qui (stesso file, stesso bug). */
