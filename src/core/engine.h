 ...
 * ============================================================
 * Questo è il modulo più differenziante rispetto a Redis.
 *
 * Redis: 1 thread principale processa TUTTI i comandi → bottleneck.
 ...
 *
 * Schema:
 *   16384 slot (compatibili Redis Cluster)
...
#define NEX_HASH_SLOTS 16384   /* Compatibile Redis Cluster */
...
typedef enum NexCmdType {
    /* Comandi base Redis-compatibili */
    NEX_CMD_GET = 0,
    NEX_CMD_SET = 1,
    NEX_CMD_DEL = 2,
    NEX_CMD_MGET = 3,
 ...
 * Usa CRC16 compatibile con Redis Cluster.
 */
