 ...
 * ============================================================
 * Come NexCache 9.0: usa memory prefetching per ridurre i cache miss
 * quando accediamo a strutture dati predittivamente.
 *
 * NexCache 9.0 ha ottenuto +40% throughput anche grazie a questo.
...
/* ── Prefetch array (come NexCache 9 per hash lookup) ─────────── */
/*
