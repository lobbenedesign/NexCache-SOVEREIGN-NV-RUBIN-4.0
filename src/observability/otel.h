 ...
 * ============================================================
 * Né NexCache né NexCache hanno osservabilità integrata nel core.
 * Serve sempre un tool esterno (NexCache Insight, BetterDB, ecc.)
 *
 ...
 *   - Hot key detection real-time (come NexCache 8.6 HOTKEYS)
