...
#define LTTNG_UST_TRACEPOINT_PROVIDER nexcache_rdb

#undef LTTNG_UST_TRACEPOINT_INCLUDE
#define LTTNG_UST_TRACEPOINT_INCLUDE "./trace_rdb.h"

#if !defined(__NEXCACHE_TRACE_SYS_H__) || defined(LTTNG_UST_TRACEPOINT_HEADER_MULTI_READ)
#define __NEXCACHE_TRACE_SYS_H__
...
LTTNG_UST_TRACEPOINT_EVENT_INSTANCE(
    ...
    nexcache_rdb, nexcache_rdb_class, nexcache_rdb, fork,
...
LTTNG_UST_TRACEPOINT_EVENT_INSTANCE(
    /* Name of the tracepoint class provider */
    nexcache_rdb, nexcache_rdb_class, nexcache_rdb, rdb_unlink_temp_file,
...
#define nexcache_rdb_trace(...) lttng_ust_tracepoint(__VA_ARGS__)

#endif /* __NEXCACHE_TRACE_SYS_H__ */

#include <lttng/tracepoint-event.h>

#else /* USE_LTTNG */

#ifndef __NEXCACHE_TRACE_SYS_H__
#define __NEXCACHE_TRACE_SYS_H__

/* avoid compiler warning on empty source file */
static inline void __nexcache_rdb_trace(void) {
}

#define nexcache_rdb_trace(...) \
    do {                     \
    } while (0)
