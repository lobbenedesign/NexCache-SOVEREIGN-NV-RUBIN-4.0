...
#define LTTNG_UST_TRACEPOINT_PROVIDER nexcache_commands

#undef LTTNG_UST_TRACEPOINT_INCLUDE
#define LTTNG_UST_TRACEPOINT_INCLUDE "./trace_commands.h"

#if !defined(__NEXCACHE_TRACE_COMMANDS_H__) || defined(LTTNG_UST_TRACEPOINT_HEADER_MULTI_READ)
#define __NEXCACHE_TRACE_COMMANDS_H__
...
LTTNG_UST_TRACEPOINT_EVENT(
	...
	/* Output event fields */
	LTTNG_UST_TP_FIELDS(
		lttng_ust_field_enum(nexcache_commands, nexcache_conn_type_enum, int, enum_field, prot)
...
#define nexcache_commands_trace(...) lttng_ust_tracepoint(__VA_ARGS__)

#endif /* __NEXCACHE_TRACE_COMMANDS_H__ */

#include <lttng/tracepoint-event.h>

#else /* USE_LTTNG */

#ifndef __NEXCACHE_TRACE_COMMANDS_H__
#define __NEXCACHE_TRACE_COMMANDS_H__

/* avoid compiler warning on empty source file */
static inline void __nexcache_commands_trace(void) {
}

#define nexcache_commands_trace(...) \
    do {                           \
    } while (0)
